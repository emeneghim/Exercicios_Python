...
peso = float(input("Insira quantos kg de peixe Joao trouxe: "))
excesso = peso-50
if excesso<0:
    excesso = 0
multa = excesso*4

print("O peso total foi de",str(peso)+"kg")
print("O excesso total foi de",str(excesso)+"kg")
print("Portanto a multa foi de R$"+str(multa))